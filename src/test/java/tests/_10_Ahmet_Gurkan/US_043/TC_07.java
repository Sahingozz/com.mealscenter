...
public class TC_07 extends TestBaseReport {
    ...
    public void test07(){
        ...
        extentTest=extentReports.createTest("US_043_TC_07","Istenen isme gore siralandigi dogrulanir.");
        ...
        extentTest.info("Name yazisina tiklandi.");
        ...
        extentTest.info("Isme gore siralandi.");
