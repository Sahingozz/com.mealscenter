...
public class TC_02 extends TestBaseReport {
    ...
    private void TC_01(){
        ...
        extentTest= extentReports.createTest("TC_02", "Verify that Delivery on ist way button is visible and working");
        ...
        // 5- User clicks Delivery on ist way button
        merchantDashboard.deliveryOnItsWay.click();

        extentTest.info("Delivery on ist way is visible ");

        // 6- Delivery on ist way is working
        Assert.assertTrue(merchantDashboard.deliveryOnItsWayOk.isDisplayed());

        extentTest.info("Delivery on ist way is working ");
