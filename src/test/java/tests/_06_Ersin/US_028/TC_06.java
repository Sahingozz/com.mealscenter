...
public class TC_06 extends TestBaseReport {
    ...
    private void TC_01(){
        ...
        extentTest= extentReports.createTest("TC_06", "Verify that Delivery Failed button is visible and working");
        ...
        // 5- User verifies Delivery Failed button is visible
        Assert.assertTrue(merchantDashboard.deliveryFailed.isDisplayed());

        extentTest.info("Delivery Failed button is visible");

        // 6- User clicks Delivery Failed button
        merchantDashboard.deliveryFailed.click();

        extentTest.info("Delivery Failed button is working");
