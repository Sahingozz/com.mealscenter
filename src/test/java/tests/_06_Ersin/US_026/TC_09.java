...
public class TC_09 extends TestBaseReport {
    ...
    private void TC_01() {
        ...
        extentTest= extentReports.createTest("TC_09", "Verify that Timeline button is visible ");
        ...
        // 7- User verifies Timeline button is visible
        Assert.assertTrue(merchantDashboard.timeline.isDisplayed());

        extentTest.info("Timeline button is visible");
