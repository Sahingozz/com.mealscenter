...
public class TC_08 extends TestBaseReport {
         ...
         @Test
         public void TC_08(){
             extentTest=extentReports.createTest("US_36 TC_08","Ilgili Alanin gorunur ve Tiklanabilir oldugu dogrulanmali");
             ...
             extentTest.info("Merchant linki tiklandi ve acilan sayfada bulunan 'Total Refund' bolumununun ozet bilgiler icerdigi dogrulandi");
