...
public class TC_02 extends TestBaseReport {
    ...
    @Test
    public void TC_02(){
        extentTest=extentReports.createTest("US_36 TC_02","Ilgili Alanin gorunur ve Tiklanabilir oldugu dogrulanmali");
        ...
        extentTest.info("Dashboard sayfasina tiklandi ve sayfanin gorunur oldugu ve ozet degerlerin bulundugu dogrulandi");
