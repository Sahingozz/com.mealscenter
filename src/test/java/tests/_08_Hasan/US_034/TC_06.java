...
public class TC_06 extends TestBaseReport {
    ...
    public void TC_06(){
        ...
        Select select=new Select(merchantDashboard.deliveryChargeTypeSelect);
        select.getOptions().get(1).click();
        extentTest.info("index(1) deki eleman secildi");
        Assert.assertTrue(merchantDashboard.fixedChargeSelect.isEnabled());
        extentTest.info("Secilen  alaninin secilebilir ve erisilebilir oldugu dogrulandi");
