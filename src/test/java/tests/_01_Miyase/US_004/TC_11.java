...
public class TC_11 extends TestBaseReport {
     ...
     * -Confirm that Social Media YouTube Link in the footer section is visible
     * -Confirm that Social Media YouTube Link in the footer section is active by clicking on the function
     * -Close the page
     */
