...
public class TC_08 extends TestBaseReport {
     ...
     * -Confirm that Social Media Instagram Link in the footer section is visible
     * -Confirm that Social Media Instagram Link in the footer section is active by clicking on the function
     * -Close the page
     */
