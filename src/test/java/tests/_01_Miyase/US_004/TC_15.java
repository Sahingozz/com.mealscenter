...
public class TC_15 extends TestBaseReport {
     ...
     * -Confirm that Blog Benefits Link in the footer section is visible
     * -Confirm that Blog  Benefits Link in the footer section is active by clicking on the function
     * -Close the page
     */
